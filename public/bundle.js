...
const Main = __webpack_require__(41);
const {applyMiddleware, createStore} = __webpack_require__(23)
const { Provider } = __webpack_require__(19)
const logger = __webpack_require__(73);

const reducer = __webpack_require__(74)
...
ReactDOM.render(
  React.createElement(Provider, {store: store}, React.createElement(Main, null)),
...
const React = __webpack_require__(1);
const ReactDOM = __webpack_require__(5);
const { connect } =  __webpack_require__(19)

const ComponentsSidebar = __webpack_require__(69);
const BugList = __webpack_require__(70);
const ContributorsSidebar = __webpack_require__(71);
  ...
  render() {
    ...
    return(
      React.createElement(React.Fragment, null, 
        React.createElement(ComponentsSidebar, null), 
        React.createElement(BugList, null), 
        React.createElement(ContributorsSidebar, {contributors: contributors, loadContributions: loadContributions})
      )
    );
  }
 }
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(12), __webpack_require__(60)(module)))
...
class ComponentsSidebar extends React.Component {
  ...
  renderSearchInput() {
    return (
      React.createElement("div", {className: "separated"}, 
        React.createElement("input", {className: "search-input", name: "search", type: "text", placeholder: "Search displayed bugs"})
      )
    );
  }
  ...
  renderCheckboxes() {
    return (
      React.createElement("ul", {className: "filter-list filters separated"}, 
        React.createElement("li", {key: "good-first"}, 
          ...
          React.createElement("label", {htmlFor: "good-first"}, "Good first bugs")
        ), 
        React.createElement("li", {key: "mentored"}, 
          React.createElement("input", {
            id: "mentored", 
            name: "mentored", 
            type: "checkbox", 
            value: "mentored", onChange: this.onFilterChange}), 
          React.createElement("label", {htmlFor: "mentored"}, "Mentored bugs")
        )
      )
    );
  }
  ...
  renderComponents() {
    return (
      React.createElement("ul", {className: "tools-list filters separated"}, 
  ...
  render() {
    ...
    return(
      React.createElement("aside", {className: "sidebar box"}, 
        searchInput, 
        checkboxes, 
        components
      )
  ...
  render() {
    return (
      React.createElement("div", {className: "main"}, 
        React.createElement("ul", {className: "bugs box loading"})
      )
    );
  }
 }
...
class ContributorsSidebar extends React.Component {
  ...
  renderContributor([name, bugCount]) {
    return (
      React.createElement("li", {key: name, className: "contributor"}, 
        name, " (", bugCount, ")"
      )
    );
  }
  ...
  renderLoading() {
    return React.createElement("aside", {className: "sidebar box loading"});
  }
  ...
  render() {
    ...
    return(
      React.createElement("div", {className: "sidebar box"}, 
        React.createElement("ul", {id: "top-contributors", className: "top-contributors"}, 
          React.createElement("li", {className: "summary"}, bugNumber, " bugs were fixed by contributors in the last 30 days: "), 
